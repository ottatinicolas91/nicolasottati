...
export default function NavbarFixed() {
  return (
    <header className="z-[999] relative">
      <motion.div
        className="fixed top-0 left-0 right-0 transition-all duration-200 fade-in-out bg-white dark:bg-black shadow-md w-full rounded-none border border-white border-opacity-40 bg-opacity-80 shadow-black/[0.03] backdrop-blur-[0.5rem] dark:border-black/40 dark:bg-opacity-75"
